...
describe('bandcamp routes', function() {
  ...
  it('should get the details of a track from URL in default format', function(done) {
  ...
  it('should get the details of a track from URL in short format', function(done) {
    var videoUrl = 'https://youtu.be/HiAVfLYNoVM';
